...
\citep{minamoto2026accumulation}, we argue that compaction is
...
See \cite{minamoto2026accumulation}, Section~2 for the precise definition.
...
We summarize the relevant framework from \citet{minamoto2026accumulation};
readers familiar with that paper may skip to Section~3.
...
The central claim of \citet{minamoto2026accumulation} is that prior interpretive
...
LightThinker++ \citep{lighttinkerplusplus2026} introduces three explicit
...
\bibitem[LightThinker++(2026)]{lighttinkerplusplus2026}
...
\bibitem[Minamoto(2026)]{minamoto2026accumulation}
Minamoto, M. (2026).
Abductive accumulation: Why interpretive frames persist, and how they
drive hallucination in language models.
Preprint.
